 ...
 * @dev Deploys contracts with testnet-specific configuration
 */
contract DeployTestnet is Script {
    ...
    function setUp() public {
        ...
        console.log("Testnet Deployer address:", owner);
        console.log("Testnet Deployer balance:", owner.balance);
        
        // Verify we have enough ETH for deployment
        require(owner.balance >= 0.1 ether, "Insufficient balance for deployment");
    }
    ...
    function run() public {
        ...
        // Setup testnet protocols and tokens
        _setupProtocols();
        _setupTokens();
        
        // Setup testnet strategies
        _setupStrategies();
    ...
    function _initializeContracts() internal {
        console.log("Initializing contracts for Sepolia...");
    ...
    function _setupProtocols() internal {
        console.log("Setting up testnet protocols...");
    ...
    function _setupTokens() internal {
        console.log("Setting up testnet tokens...");
    ...
    function _setupStrategies() internal {
        console.log("Setting up testnet strategies...");
    ...
    function _logDeployment() internal view {
        ...
        console.log("Etherscan: https://sepolia.etherscan.io/address/", address(restakeLPHook));
        console.log("====================================\n");
    }
}
