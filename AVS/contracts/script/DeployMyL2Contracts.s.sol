...
import {RestakeLPHook} from "@project/l2-contracts/RestakeLPHook.sol";
import {LiquidityManagerL2} from "@project/l2-contracts/LiquidityManagerL2.sol"; // Import your L2 custom contract
...
contract DeployMyL2Contracts is Script {
    ...
    function run(string memory environment, string memory _context) public {
        ...
        // Deploy RestakeLP L2 contracts
        LiquidityManagerL2 liquidityManagerL2 = new LiquidityManagerL2();
        console.log("LiquidityManagerL2 deployed to:", address(liquidityManagerL2));
        ...
        outputs[0] = Output({name: "LiquidityManagerL2", contractAddress: address(liquidityManagerL2)});
    ...
    function _readContext(
        ...
        context.restakeLPHook = RestakeLPHook(_readAVSL2ConfigAddress(environment, "restakeLPHook"));
