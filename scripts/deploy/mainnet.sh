...
# RestakeLP Hook AVS - Mainnet Deployment Script
# This script deploys all contracts to Ethereum mainnet

set -e

echo "🚀 Starting RestakeLP Hook AVS deployment to Ethereum mainnet..."
...
if [ $(cast to-unit $BALANCE ether | cut -d. -f1) -lt 5 ]; then
    echo "❌ Insufficient balance. Please fund your account with at least 5 ETH"
    exit 1
fi
...
echo "   Make sure you have tested thoroughly on testnet."
echo ""
...
echo ""
echo "🔗 Etherscan: https://etherscan.io/address/$RESTAKE_HOOK_ADDRESS"
echo "📄 Deployment saved to: deployments/mainnet.json"
echo ""
echo "🎉 RestakeLP Hook AVS is now live on Ethereum mainnet!"
